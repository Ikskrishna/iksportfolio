    ...
    <div className=' text-[#FFE1A8] shadow-2xl bg-'>
      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col gap-10">
        ...
        <ul className="mt-4 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-6">
          <li className="bg-[#FFE1A8] text-black shadow-sm text-2xl px-5 py-5 rounded-2xl">Chat GPT</li>
          <li className="bg-[#FFE1A8] text-black shadow-sm text-2xl px-5 py-5 rounded-2xl">Visual Studio</li>
          <li className="bg-[#FFE1A8] text-black shadow-sm text-2xl px-5 py-5 rounded-2xl">Netlify</li>
        </ul>
      </div>
    </section>
    </div>
